...
<body>
	...
	<?php 
	$data = $koneksi -> query("SELECT * FROM kas WHERE jenis='keluar'");
	$i=1;
	$total=0;
	...
	<?php $i++; ?>
	<?php $total += $dta['keluar']; ?>
<?php endwhile; ?>
	<tr>
       <td colspan="5" style="text-align: left; font-size: 17px; color: maroon;">Total Uang Keluar :</td>
