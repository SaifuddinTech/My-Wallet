            ...
            <div class="col-md-12">
                <div class="card mb-4" style="padding:23px">
                    <div class="row" style="padding:0px 25px 15px 25px">
                        ...
                        <div class="col-6 text-end">
                            <span title="Tambah Data">
                                <button type="button" class="btn bg-success btn-block" data-bs-toggle="modal" data-bs-target="#tambahdatakeluar">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                            ...
                            <table class="table align-items-center mb-0 table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="text-center">
                                                <a id="edit_data" data-bs-toggle="modal" data-bs-target="#edit" data-id="<?php echo $data['kode']; ?>" data-ket="<?php echo $data['keterangan']; ?>" data-tgl="<?php echo $data['tgl']; ?>" data-jml="<?php echo $data['keluar']; ?>" class="btn btn-warning btn-md" Style="margin-bottom:0px" title="Ubah Data"><i class="fa-solid fa-pen-to-square fa-lg"> </i></a>
                                                <a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="?page=keluar&aksi=hapus&id=<?php echo $data['kode'];?>" class="btn btn-danger btn-md" Style="margin-bottom:0px" title="Hapus Data"><i class="fa-solid fa-trash-can fa-lg"> </i></a>
                                            </td>
                                        </tr>
                                        <?php 
                                ...
                                <tr class="text-center">
                                    <td colspan="4" style="text-align: left; font-size: 17px; color: maroon;">Total Uang Keluar :</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><a href="page/kas_keluar/laporan_keluar.php" target="_blank"><button class="btn btn-primary btn-sm" > CETAK</button></a></center>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <!--  Halaman Tambah-->
                        <div class="col-md-4">
                            <div class="modal fade" id="tambahdatakeluar" tabindex="-1" role="dialog" aria-labelledby="Tambah_Data_Kas_Masuk" aria-hidden="true">
                                        ...
                                        <div class="modal-body p-0">
                                            <div class="card card-plain">
                                                <div class="card-header pb-0 text-left">
                                                    ...
                                                    <p class="mb-0">Data Uang Keluar</p>
                                                </div>
