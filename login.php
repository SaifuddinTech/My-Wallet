...
?>
    ...
    <head>
        ...
        <title>Login My Wallet Sistem Kas</title>
    </head>
    <body>
    <section class="vh-100">
            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                        <button class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" type="submit">Masuk</button>
                        <p class="small fw-bold mt-2 pt-1 mb-0">Belum mempunyai akun? <a href="daftar.php"
        ...
        <div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 bg-primary">
            ...
            <a href="https://youtube.com/@gendonkusumojatiofficial23" class="text-white me-4">
